...
var _SampleComponent = __webpack_require__(/*! ./SampleComponent */ "./app/components/SampleComponent.js");
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        null,
        _react2.default.createElement(_reactRouterDom.Route, { component: _SampleComponent2.default })
      )
    )
  );
};
...
/***/ "./app/components/SampleComponent.js":
/*!*******************************************!*\
  !*** ./app/components/SampleComponent.js ***!
  \*******************************************/
/*! no static exports found */
...
var testResponse = function testResponse(event) {
  var _console;
  ...
  (_console = console).log.apply(_console, ['received response from main'].concat(args));
};

// a function to emit an event that the main process is listening for
var emitTestEvent = function emitTestEvent() {
  _electron.ipcRenderer.send('test', 'emitted a message from the renderer process!');
};
...
var SampleComponent = function (_Component) {
  ...
  _createClass(SampleComponent, [{
    ...
    value: function componentDidMount() {
      ...
      _electron.ipcRenderer.on('test-reply', testResponse);
    }
  }, {
    ...
    value: function componetWillUnmount() {
      ...
      _electron.ipcRenderer.removeListener('test-reply', testResponse);
    }
  }, {
    key: 'render',
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'h5',
          null,
          'Sample component with event emitters and listeners!'
        ),
        _react2.default.createElement(
          'button',
...
var _Root = __webpack_require__(/*! ./components/Root.js */ "./app/components/Root.js");
